...
(function(factory){
    ...
    function _fnBrowserDetect(settings){
        ...
        if(!DataTable.__browser){
            ...
            var n = $('<div/>')
            .css({
                position: 'fixed', top: 0, left: 0, height: 1, width: 1, overflow: 'hidden'
            })
            .append($('<div/>')
            .css({
    ...
    function _fnAddColumn(oSettings, nTh){
        ...
        var oCol = $.extend({}, DataTable.models.oColumn, oDefaults, {
            "nTh": nTh ? nTh : document.createElement('th'), "sTitle": oDefaults.sTitle ? oDefaults.sTitle : nTh ? nTh.innerHTML : '', "aDataSort": oDefaults.aDataSort ? oDefaults.aDataSort : [iCol], "mData": oDefaults.mData ? oDefaults.mData : iCol, idx: iCol
        });
    ...
    function _fnAddOptionsHtml(oSettings){
        ...
        var insert = $('<div/>', {
            id: oSettings.sTableId + '_wrapper', 'class': classes.sWrapper + (oSettings.nTFoot ? '' : ' ' + classes.sNoFooter)
        });
            ...
            "data": data, "success": function(json){
                ...
                if($.inArray(true, ret) === -1){
                    if(error == "parsererror"){
                        ...
                        alert('系统出现错误');
                    }else if(xhr.readyState === AppKey.code.code204){
                        //_fnLog( oSettings, 0, 'Ajax error', 7 );
                        alert('系统出现错误');
                    }else if(xhr.readyState === AppKey.code.code401){
                        //_fnLog( oSettings, 0, 'Ajax error', 7 );
                        alert('系统出现错误');
    ...
    function _fnAjaxParameters(settings){
        ...
        for(i = 0; i < columnCount; i++){
            ...
            d.columns.push({
                data: dataProp, name: column.sName, searchable: column.bSearchable, orderable: column.bSortable, search: {
        ...
        var searchFn = function(){
            ...
            if(val != previousSearch.sSearch){
                _fnFilterComplete(settings, {
                    "sSearch": val, "bRegex": previousSearch.bRegex, "bSmart": previousSearch.bSmart, "bCaseInsensitive": previousSearch.bCaseInsensitive
                });
    ...
    function _fnFeatureHtmlProcessing(settings){
        return $('<div/>', {
            'id': !settings.aanFeatures.r ? settings.sTableId + '_processing' : null, 'class': settings.oClasses.sProcessing
        })
    ...
    function _fnSortFlatten(settings){
        ...
        for(i = 0; i < nestedSort.length; i++){
            ...
            for(k = 0, kLen = aDataSort.length; k < kLen; k++){
                ...
                aSort.push({
                    src: srcCol, col: iCol, dir: nestedSort[i][1], index: nestedSort[i]._idx, type: sType, formatter: DataTable.ext.type.order[sType + "-pre"]
                });
            }
        }
        return aSort;
    ...
    function _fnSaveState(settings){
        ...
        var state = {
            time: +new Date(), start: settings._iDisplayStart, length: settings._iDisplayLength, order: $.extend(true, [], settings.aaSorting), search: _fnSearchToCamel(settings.oPreviousSearch), columns: $.map(settings.aoColumns, function(col, i){
                return {
                ...
                $(rowOne[0]).children('th, td').each(function(i, cell){
                    ...
                    if(col.mData === i){
                        ...
                        if(sort !== null || filter !== null){
                            col.mData = {
                                _: i + '.display', sort: sort !== null ? i + '.@data-' + sort : undefined, type: sort !== null ? i + '.@data-' + sort : undefined, filter: filter !== null ? i + '.@data-' + filter : undefined
                            };
    ...
    $.extend(_Api.prototype, {
        ...
        }, pop: __arrayProto.pop, push: __arrayProto.push, // Does not return an API instance
        reduce: __arrayProto.reduce || function(fn, init){
            return _fnReduce(this, fn, init, 0, this.length, 1);
        }, reduceRight: __arrayProto.reduceRight || function(fn, init){
            return _fnReduce(this, fn, init, this.length - 1, -1, -1);
        }, reverse: __arrayProto.reverse, // Object with rows, columns and opts
    ...
    _Api.register = _api_register = function(name, val){
        ...
        for(i = 0, ien = heir.length; i < ien; i++){
            ...
            if(!src){
                src = {
                    name: key, val: {}, methodExt: [], propExt: []
                };
                struct.push(src);
            }
            if(i === ien - 1){
    ...
    _api_register('search()', function(input, regex, smart, caseInsen){
        ...
        return this.iterator('table', function(settings){
            ...
            _fnFilterComplete(settings, $.extend({}, settings.oPreviousSearch, {
                "sSearch": input + "", "bRegex": regex === null ? false : regex, "bSmart": smart === null ? true : smart, "bCaseInsensitive": caseInsen === null ? true : caseInsen
            }), 1);
        });
    });
    ...
    DataTable.util = {
        throttle: _fnThrottle, escapeRegex: _fnEscapeRegex
    };
    ...
    DataTable.defaults = {
        "aaData": null, "aaSorting": [[0, 'asc']], "aaSortingFixed": [], "ajax": null, "aLengthMenu": [20, 25, 50, 99],//默认的显示可选下拉菜单条目,[[10, 25, 50, -1], [10, 25, 50, "All"]]
        ...
        }, "fnStateSaveParams": null, "iStateDuration": 7200, "iDeferLoading": null, "iDisplayLength": 20,//默认每页显示数
        "iDisplayStart": 0, "iTabIndex": 0, "oClasses": {}, "oLanguage": {
            "oAria": {
                "sSortAscending": ": activate to sort column ascending", "sSortDescending": ": activate to sort column descending"
            }, "oPaginate": {
                "sFirst": "<i title='第一页' class='fa fa-step-backward'></i>", "sLast": "<i title='最后页' class='fa fa-step-forward'></i>", "sNext": "<i title='下一页' class='fa fa-arrow-right'></i>", "sPrevious": "<i title='上一页' class='fa fa-arrow-left'></i>"
            }, "sEmptyTable": "没有可用的数据", "sInfo": "显示 _START_ 到 _END_ 共计 _TOTAL_ 数据 ", "sInfoEmpty": "暂无数据", "sInfoFiltered": "(filtered from _MAX_ total entries)", "sInfoPostFix": "", "sDecimal": "", "sThousands": ",", "sLengthMenu": "显示 _MENU_ 条目", "sLoadingRecords": "正在加载……",//显示加载提示
            "sProcessing": "<img src='/js/layer/theme/default/loading-1.gif' />正在处理……", "sSearch": "搜索:", "sSearchPlaceholder": "", "sUrl": "", "sZeroRecords": "没有找到相关数据"
        }, "oSearch": $.extend({}, DataTable.models.oSearch), "sAjaxDataProp": "data", "sAjaxSource": null, "sDom": "lfrtip", "searchDelay": null, "sPaginationType": "full_numbers",//显示分页按钮风格
        "sScrollX": "", "sScrollXInner": "", "sScrollY": "", "sServerMethod": "GET", "renderer": null, "rowId": "DT_RowId"
    };
    _fnHungarianMap(DataTable.defaults);
    DataTable.defaults.column = {
        "aDataSort": null, "iDataSort": -1, "asSorting": ['asc', 'desc'], "bSearchable": true, "bSortable": true, "bVisible": true, "fnCreatedCell": null, "mData": null, "mRender": null, "sCellType": "td", "sClass": "", "sContentPadding": "", "sDefaultContent": null, "sName": "", "sSortDataType": "std", "sTitle": null, "sType": null, "sWidth": null
    };
    ...
    DataTable.models.oSettings = {
        ...
        "oBrowser": {
            "bScrollOversize": false, "bScrollbarLeft": false, "bBounding": false, "barWidth": 0
        },
        "ajax": null,
        "aanFeatures": [],
        "aoData": [],
    ...
    DataTable.ext = _ext = {
        buttons: {}, classes: {}, builder: "-source-", errMode: "alert", feature: [], search: [], selector: {
            cell: [], column: [], row: []
        }, internal: {}, legacy: {
            ajax: null
        }, pager: {}, renderer: {
            ...
            detect: [], search: {}, order: {}
        }, _unique: 0, fnVersionCheck: DataTable.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: DataTable.version
    };
    $.extend(_ext, {
        afnFiltering: _ext.search, aTypes: _ext.type.detect, ofnSearch: _ext.type.search, oSort: _ext.type.order, afnSortData: _ext.order, aoFeatures: _ext.feature, oApi: _ext.internal, oStdClasses: _ext.classes, oPagination: _ext.pager
    });
    $.extend(DataTable.ext.classes, {
        "sTable": "dataTable", "sNoFooter": "no-footer", /* Paging buttons */
        ...
        "sSortAsc": "sorting_asc", "sSortDesc": "sorting_desc", "sSortable": "sorting",
        ...
        "sHeaderTH": "", "sFooterTH": "", // Deprecated
    ...
    (function(){
        ...
        $.extend(DataTable.ext.oJUIClasses, DataTable.ext.classes, {
            ...
            /* Sorting */
            "sSortAsc": _stateDefault + " sorting_asc", "sSortDesc": _stateDefault + " sorting_desc", "sSortable": _stateDefault + " sorting", "sSortableAsc": _stateDefault + " sorting_asc_disabled", "sSortableDesc": _stateDefault + " sorting_desc_disabled", "sSortableNone": _stateDefault + " sorting_disabled", "sSortJUIAsc": _sortIcon + "triangle-1-n", "sSortJUIDesc": _sortIcon + "triangle-1-s", "sSortJUI": _sortIcon + "carat-2-n-s", "sSortJUIAscAllowed": _sortIcon + "carat-1-n", "sSortJUIDescAllowed": _sortIcon + "carat-1-s", "sSortJUIWrapper": "DataTables_sort_wrapper", "sSortIcon": "DataTables_sort_icon", /* Scrolling */
            "sScrollHead": "dataTables_scrollHead " + _stateDefault, "sScrollFoot": "dataTables_scrollFoot " + _stateDefault, /* Misc */
    ...
    $.extend(extPagination, {
        ...
        }, _numbers: _numbers, numbers_length: 7//默认显示的是7可见按钮
    });
                ...
                var attach = function(container, buttons){
                    ...
                    for(i = 0, ien = buttons.length; i < ien; i++){
                        ...
                        if($.isArray(button)){
                            ...
                            if(btnDisplay !== null){
                                node = $('<a>', {
                                    'class': classes.sPageButton + ' ' + btnClass, 'aria-controls': settings.sTableId, 'aria-label': aria[button], 'data-dt-idx': counter, 'tabindex': settings.iTabIndex, 'id': idx === 0 && typeof button === 'string' ? settings.sTableId + '_' + button : null
                                })
                                .html(btnDisplay)
                                .appendTo(container);
