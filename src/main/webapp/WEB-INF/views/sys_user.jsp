            ...
            var thisTable = pageDataTable.initDataTable({
                ...
                columnDefs : [
                    ...
                    },
                    {
                        targets : -1,
                        render : function(value,type,row,meta){
                            var html = "<a href='javascript:thisPage.rowEdit("+meta.row+");' style='outline:none;text-decoration: none;color:#3b8cff;margin-left:6px;'>编辑</a>" +
                            "<a href='javascript:thisPage.rowDel("+meta.row+");' style='outline:none;text-decoration: none;color:#f00;margin-left:6px;'>删除</a>" +
                            ...
                            "<a href='javascript:thisPage.rowDisable("+meta.row+");' style='outline:none;text-decoration: none;color:#33a3dc;margin-left:6px;'>启用禁用</a>"+
                            "<a class='hidden-xs' href='javascript:thisPage.rowUserMenu("+meta.row+");' style='outline:none;text-decoration: none;color:#008792;margin-left:6px;'>私有菜单</a>"+
