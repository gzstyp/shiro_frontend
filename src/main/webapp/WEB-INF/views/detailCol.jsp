                            ...
                            <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                    ...
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                        <li>
                                            <a href="javascript:;" class="tooltip-success" data-rel="tooltip" title="编辑">
                                                <span class="green">
                                        ...
                                        <li>
                                            <a href="javascript:;" class="tooltip-error" data-rel="tooltip" title="删除">
                                                <span class="red">
                                                    <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                    删除
                                                </span>
        ...
        jQuery(function($){
            ...
            /*
                <tr>
                    ...
                    <td class="center">
                        <div class="action-buttons"><a href="javascript:;" class="green bigger-140 show-details-btn" title="点击显示详细信息"><i class="ace-icon fa fa-angle-double-down"></i><span class="sr-only">详细信息</span></a></div>
                    </td>
                    <td><a href="javascript:;">admin</a></td>
                    <td>正常</td>
                    <td class="hidden-480">2020-01-14 10:07</td>
                    <td>2020-04-14 11:57</td>
                    <td>
                        ...
                        <div class="hidden-md hidden-lg">
                            <div class="inline pos-rel">
                                ...
                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    <li>
                                        <a href="javascript:;" class="tooltip-success" data-rel="tooltip" title="编辑">
                                            <span class="green"><i class="ace-icon fa fa-pencil-square-o bigger-120"></i>编辑</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" class="tooltip-error" data-rel="tooltip" title="删除">
                                            <span class="red">i class="ace-icon fa fa-trash-o bigger-120"></i>删除</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
